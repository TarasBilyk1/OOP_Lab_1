    ...
    public static void main(String[] args)
    {
        ...
        do
        {
            ...
            /*------------------------ Завдання 2 -------------------------*/
                ...
                User user1 = new User(1, 18, "Taras", "Bilyk", 86.1, 190.5);
                User user2 = new User(2, 19, "Nazar", "Samoilevich", 70.5, 182.4);
                User user3 = new User(3, 20, "Oleg", "Tokarchk", 78.3, 183.2);
                User user4 = new User(4, 18, "Yliya", "Varga", 54.8, 163.2);
                User user5 = new User(5, 19, "Petro", "Mostovchuk", 75.7, 176.9);
                User user6 = new User(6, 21, "Andriy", "Olenyk", 76.4, 186.4);
                User user7 = new User(7, 20, "Liza", "Omelkovich", 60.1, 165.7);
                User user8 = new User(8, 18, "Roman", "Horbach", 76.2, 184.2);
                User user9 = new User(9, 21, "Pavlo", "Oliar", 80.2, 170.3);
                User user10 = new User(10, 19, "Maksym", "Rozenblum", 81.4, 179.7);
